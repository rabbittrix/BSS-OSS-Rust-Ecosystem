//! Request handlers for TMF677 API endpoints
...
#[utoipa::path(
    get,
    path = "/tmf-api/usageConsumptionManagement/v4/usageConsumption",
    responses(
...
#[utoipa::path(
    get,
    path = "/tmf-api/usageConsumptionManagement/v4/usageConsumption/{id}",
    responses(
